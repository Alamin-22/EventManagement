...
const WhyChoose_us = () => {
    return (
        <div className='flex flex-col md:flex-row justify-evenly gap-7 mx-12'>
            <div data-aos="fade-down" data-aos-duration="3000"  className="card  bg-purple-100 shadow-xl">
            ...
            <div data-aos="fade-up" data-aos-duration="3000" className="card  bg-purple-100 shadow-xl">
                <figure className="px-10 pt-7">
